...
def get_arg_parser():
    ...
    parser.add_argument("--batch_size", type=int, default=2, help='the batchsize for the dataloader' )
    parser.add_argument("--test_batch", type=int, default=2, help='the batchsize for the evaluation')
